...
if __name__ == "__main__":
    ld = LoadData()
    #ld.create_db("sensors3data")
    #ld.create_tables("sensors3data", r"C:\Users\DELL\Documents\dataeng\dags\180_stations_schema.sql")
    #ld.create_tables("sensors3data", r"C:\Users\DELL\Documents\dataeng\dags\180_davis_schema.sql")
    ld.csv_to_sql(" ", "I80Stations", r"C:\Users\DELL\Documents\dataeng\data\I80_stations.csv")
    ld.csv_to_sql("sensors3data", "I80Davis", r"C:\Users\DELL\Documents\dataeng\data\180_sample.txt")