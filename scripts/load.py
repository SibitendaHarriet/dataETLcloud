...
station_sqlFile = r'C:\Users\DELL\Documents\dataeng\dags\180_stations_schema.sql'
sensor_sqlFile = r'C:\Users\DELL\Documents\dataeng\dags\180_davis_schema.sql'
...
def insert_data_to_table(dbName: str, tableName: str) -> None:
    try:
        conn, cur = DBConnect(dbName)
        df = pd.read_csv(r"C:\Users\DELL\Documents\dataeng\data\I80_stations.csv")
